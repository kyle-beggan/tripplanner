...
export default async function Home() {
    ...
    if (!user) {
        // If no user, we might want to show a landing page or redirect to login
        // But since the request is "app at root", let's redirect unauthenticated only
        // middleware protects this anyway usually, but good to be safe.
        // Actually, middleware redirects to /login if no user.
        return null
    }
