                    ...
                    >
                        ...
                        <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                            <button
                                ...
                                disabled={isLoading}
                                onClick={onConfirm}
                                className={`inline-flex w-full justify-center rounded-md px-3 py-2 text-[11px] sm:text-sm font-semibold text-white shadow-sm sm:ml-3 sm:w-auto ${isDestructive
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                onClick={onClose}
                                className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-[11px] sm:text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto"
                            >
                                {cancelLabel}
                            </button>
                        </div>
